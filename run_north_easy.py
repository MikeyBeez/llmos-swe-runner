...
Design points:
  - The passing set is built from ALL results history (runs/*/results*.json,
    ...
    resolved=true at least once. Frozen to runs/laguna/easy_set.json on
...
writes ~/swe/runs/laguna/easy1.json
"""
...
SETF = os.path.join(LDIR, "easy_set.json")
OUT = os.path.join(LDIR, "easy1.json")
MAX_ATTEMPTS = 1
