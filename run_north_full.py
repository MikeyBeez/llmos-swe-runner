...
Design points:
  - The passing set is built from ALL results history (runs/*/results*.json,
    ...
    resolved=true at least once. Frozen to runs/laguna/full_set.json on
...
writes ~/swe/runs/laguna/full1.json
"""
...
SETF = os.path.join(LDIR, "full_set.json")
OUT = os.path.join(LDIR, "full1.json")
MAX_ATTEMPTS = 1
