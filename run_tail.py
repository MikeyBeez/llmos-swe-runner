...
Design points:
  - The passing set is built from ALL results history (runs/*/results*.json,
    ...
    resolved=true at least once. Frozen to runs/laguna/tail_set.json on
...
writes ~/swe/runs/laguna/tail1.json
"""
...
SETF = os.path.join(LDIR, "tail_set.json")
OUT = os.path.join(LDIR, "tail1.json")
